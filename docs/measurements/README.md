...
`f7148710f79e356a9f624a88318681b1e9f7f237` (`f7148710`), on 2026-09-16, on Python 3.12.3, with traigent 0.26.0 installed against the guide's 0.27.0
...
git -C ~/code/traigent-first-run checkout f7148710f79e356a9f624a88318681b1e9f7f237
...
**One run cannot be measured at `f7148710`.** `best-case--off-method-calibration` asks the
...
coordinate in the check, named in `score_bank.py` beside a comment saying so. At `f7148710`
...
Two things about the rows at `f7148710`. A cap's `ceiling` may be `null` in `results.json`
...
**Every row below is the 2026-09-16 reading at `f7148710`**, taken from `cards/results.json`.
