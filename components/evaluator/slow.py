...
`SECONDS_PER_CALL` is what that round trip costs us in practice: about two
minutes. It is the number to change if the service gets faster; it is not a
